...
const context = {
  window: { location: { protocol: 'https:', hostname: 'holisticpeople.com' }, HPGMCStoreWidgetConfig: { merchantId: 5298746911, position: 'RIGHT_BOTTOM', region: 'US' }, merchantwidget: { start(args) { context.args = args; } } },
...
appended.load();
assert.deepEqual(context.args, { merchant_id: 5298746911, position: 'RIGHT_BOTTOM', region: 'US' });
