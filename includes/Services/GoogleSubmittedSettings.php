...
final class GoogleSubmittedSettings {
    ...
    private const SUPPORT = 'https://merchants.google.com/mc/businessinformation/a=5298746911';
    ...
    public static function import(array $v) {
        ...
        foreach (['url','email','phone'] as $k) if (!is_string($v['support'][$k]??null) || strlen($v['support'][$k])>160) return new \WP_Error('hp_gmc_submitted_settings_invalid','Invalid support value.');
